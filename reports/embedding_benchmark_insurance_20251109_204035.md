...
- 模型 `BAAI/bge-large-zh-v1.5` （维度 1024，集合 `benchmark_BAAI_bge_large_zh_v1_5`）
  - Recall@5: 0.8889 | Recall@10: 0.9444 | Recall@20: 1.0000 | MRR: 0.9352
- 模型 `models\finetuned_embedding_v1` （维度 1024，集合 `benchmark_models_finetuned_embedding_v1`）
  - Recall@5: 1.0000 | Recall@10: 1.0000 | Recall@20: 1.0000 | MRR: 0.9722
